...
/** Displays the active user's progress, wallet, and account actions. */
const Header = () => {
        ...
        <div className="user-stats-card">
          ...
          <div>
            <div className="stat-card-container">
              <StatCard icon={"wallet"} label={"Plånbok"} value={`${account?.balance || 0} kr`} />

              <StatCard icon={"star"} label={"XP"} value={`${account?.experience || 0}`} />
            </div>
          </div>
        </div>
      )}
